...
/*   Updated: 2023/06/10 18:23:20 by ouidriss         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	set_textures_paths(t_game *t_p)
{
	...
	t_p->paths[4] = "textures/space.xpm";
}
...
int	main(int argc, char const *argv[])
{
	...
	if (argc == 2)
	{
		...
		if (!check_rectangle(t_g) || !check_surrounded_by_wall(t_g) || \
		!check_one_exit_coll_start(t_g) || !check_flood_fill(t_g))
